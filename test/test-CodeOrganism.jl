...
module TestCodeOrganism
  ...
  #   Manager.destroy(d.man)
  # end
  # facts("Checking if left and right organisms can eat eath other and step") do
  #   local d     = create([Helper.Point(1,1), Helper.Point(2,1)], Dict{Symbol, Any}(:orgEnergySpendPeriod=>100,:orgStartEnergy=>10))
  #   local left  = d.orgs[1]
  #   local right = d.orgs[2]
  #
  #   code(d, :eatRight, left)
  #   code(d, :stepRight, left)
  #   code(d, :eatRight, left)
  #   code(d, :eatRight, left)
  #
  #   code(d, :eatLeft, right)
  #   code(d, :stepLeft, right)
  #   code(d, :eatLeft, right)
  #   code(d, :eatLeft, right)
  #
  #   @fact left.energy === right.energy === 10 --> true
  #   consume(d.task)
  #   consume(d.task)
  #   consume(d.task)
  #   @fact left.energy  --> 10
  #   @fact right.energy --> 10
  #
  #   Manager.destroy(d.man)
  # end
  ...
  # myColor
  #
  # facts("Checking if organism can get it's color") do
  #   local d   = create([Helper.Point(1,1)], Dict{Symbol, Any}(:orgEnergySpendPeriod=>100))
  #   local org = d.orgs[1]
  #
  #   org.color = UInt16(123)
  #   code(d, :myColor, org)
  #   consume(d.task)
  #   consume(d.task)
  #   @fact Code.eval(org.code)(d.cfg, org) --> f16(123)
  #
  #   org.color = UInt16(124)
  #   consume(d.task)
  #   @fact Code.eval(org.code)(d.cfg, org) --> f16(124)
  #
  #   Manager.destroy(d.man)
  # end
  # #
  # # myX, myY
  # #
  # facts("Checking if organism can get it's X coordinate") do
  #   local d   = create([Helper.Point(3,2)], Dict{Symbol, Any}(:orgEnergySpendPeriod=>100))
  #   local org = d.orgs[1]
  #
  #   code(d, :myX, org)
  #   consume(d.task)
  #   consume(d.task)
  #   @fact Code.eval(org.code)(d.cfg, org) --> f16(3)
  #
  #   Manager.destroy(d.man)
  # end
  # facts("Checking if organism can get it's Y coordinate") do
  #   local d   = create([Helper.Point(4,3)], Dict{Symbol, Any}(:orgEnergySpendPeriod=>100))
  #   local org = d.orgs[1]
  #
  #   code(d, :myY, org)
  #   consume(d.task)
  ...
  # myId
  #
  facts("Checking if organism can get it's id") do
    local d   = create([Helper.Point(4,3)], Dict{Symbol, Any}(:orgEnergySpendPeriod=>100))
    local org = d.orgs[1]

    org.id = UInt(123)
    code(d, :myId, org)
    @fact Code.eval(org.code)(d.cfg, org) --> f16(21600)

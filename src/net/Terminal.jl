...
module Terminal
  ...
  # ManagerRpc.setEnergy for details
  #
  function termSetRandomEnergy(amount::Int = Config.val(_termData.cfg, :WORLD_START_ENERGY_BLOCKS), energy::UInt32 = Config.val(_termData.cfg, :WORLD_START_ENERGY_AMOUNT))

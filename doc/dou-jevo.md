...
```julia
    ...
    var_2 = if 127 >= abs(var_33)         # если "под нами" энергия/другой организм, то var_2 = 127 иначе var_2 = 0
            Int8(var_33)                  # var_2 = 0
        else
            127                           # var_2 = 127
        end
    for i::Int8 = 1:div(var_2,16)         # если var_2 !== 0 (под нами кто-то есть) то крутимся здесь 7 раз

...
Стоит сказать, что на данный момент эта картинка значительно устарела. Сейчас, организмы располагают более богатым набором элементов языка, на основе которых сервер может дописывать их код. А именно:

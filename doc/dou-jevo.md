...
- мутировать
- передавать свои свойства следующему поколению

Для тех, кто немного разбирается в эволюционной биологии, вот список аналогов стандартным терминам (слева - биологические термины, справа термины компьютерной модели):

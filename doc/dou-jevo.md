...
Чего я достиг? Пока не много. И это только по тому, что производительность моего PC очень низкая для такой задачи. А еще у меня очень мало свободного времени :( Но тем не менее, проект растет и усложняется. На данном этапе я работаю над версией [1.1-rc1](https://github.com/tmptrash/jevo/milestone/4). После выйдет [1.1](https://github.com/tmptrash/jevo/milestone/2). Вся разработка ведется в [github](https://github.com/). Так вот, список:

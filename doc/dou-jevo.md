...
Что же мы увидели? Там было много зеленых точек, которые не двигались (это энергия, которую нужно съесть). Около пяти островков фиолетовых - это один из видов цифровых организмов, которые выжидают "бегунцов" и съедают их при приближении. И много двигающихся с разной траекторией точек (другие виды организмов - назовем их "бегунцы"). Стоит пояснить, что это результат примерно двухдневного запуска системы. Причем я никак не влиял на процесс их обучения. И никак не вмешивался. По сути, мы видим, что эволюционировали две стратегии: "жди и кусай" и "беги и кусай". Важно обратить внимание на детали: как именно они двигаются, какого они размера и, главное, почему они это делают. Давайте по порядку:
- Бегунцы двигаются по диагонали - потому что диагональ дает возможность "просканировать" все поле и найти максимум энергии. Представьте что бы было, если кто-то двигается только вверх? Рано или позно он проел бы длинный коридор и все, конец.
- В основном программы короткие, потому что большие программы тратят больше энергии на свое содержание
- По тому, что их программы управляют их поведением

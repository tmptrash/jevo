...
- И вообще, для обезьяны все это реально круто!

P.S. Если Вы заинтересованы в такого рода экспериментах, Вы биолог или просто программист, которому интересно, пишите мне на [email](mailto:deadbrainman@gmail.com) и мы объединим наши усилия для создания своего skynet ;)

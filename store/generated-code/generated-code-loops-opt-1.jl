...
[RpcApi.SimpleOrganism(0x00000000000aa5cc,:(function (o::Creature.Organism,)
     local var_46::Bool = true
     function func_35(var_33::Bool=false,var_34::Int16=22779)
         local var_51::ASCIIString = "ptpmddp1"
     ...
     Creature.stepRight(o)
     return true
 end),[100,300,95,0,1,1,1],1,5208,1,1424734,0x01a50bf0,Dict(0=>32203,-11365=>32203,-6815=>-6815,32203=>-11365,-8455=>32203,-12751=>-6815,-738=>32203,1=>1),[600,6],113)

#------------------------------------------------------------------------------------------------------------------------------

[RpcApi.SimpleOrganism(0x00000000000aea0a,:(function (o::Creature.Organism,)
     local var_46::Bool = true
     function func_35(var_33::Bool=false,var_34::Int16=22779)
         local var_51::ASCIIString = "ptpmddp1"
         local var_52::ASCIIString = "ftwMEhZ0"
     ...
     Creature.stepRight(o)
     return true
 end),[100,300,95,0,1,1,1],1,5208,1,1974284,0x01a8cd10,Dict(0=>32203,-11365=>32203,-6815=>-6815,32203=>-11365,-8455=>32203,-12751=>-6815,-738=>32203,1=>1),[1916,9],118)

 #------------------------------------------------------------------------------------------------------------------------------

[RpcApi.SimpleOrganism(0x00000000000b7473,:(function (o::Creature.Organism,)
     local var_46::Bool = true
     function func_35(var_33::Bool=false,var_34::Int16=22779)
         local var_56::Int16 = 458
         local var_53::Int16 = 17107
         local var_51::ASCIIString = "ptpmddp1"
         local var_52::ASCIIString = "ftwMEhZ0"
         Creature.stepDown(o)
         Creature.stepRight(o)
     ...
     function func_24(var_23::Int8=28)
         local var_57::Int64 = 8532844564146531811
         local var_44::Int64 = -8745441503928347880
         Creature.eatDown(o,Int(var_23))
         Creature.eatUp(o,Int(var_23))
         Creature.eatDown(o,Int(var_23))
     ...
     Creature.stepRight(o)
     return true
 end),[100,300,95,0,1,1,1],1,5208,1,1203218,0x01b04f50,Dict(0=>32203,21968=>32203,-11365=>32203,-6815=>-6815,32203=>-11365,-8455=>32203,-12751=>-6815,-738=>32203,1=>1),[22,917],118)

 #------------------------------------------------------------------------------------------------------------------------------

 [RpcApi.SimpleOrganism(0x00000000000cd2ba,:(function (o::Creature.Organism,)
        ...
        Creature.stepRight(o)
        return true
    end),[100,300,95,0,1,1,1],1,5208,1,2624889,0x01be7960,Dict(21968=>32203,-22730=>-22730,23748=>-16910,11823=>-11365,0=>32203,-11365=>-11365,-22321=>22779,458=>22779,-738=>32203,23188=>-22730,-6815=>-6815,32203=>32203,-8455=>-8455,-12751=>-6815,1=>1),[19,555],129)
...
[RpcApi.SimpleOrganism(0x00000000000d984b,:(function (o::Creature.Organism,)
        ...
        Creature.stepRight(o)
        return true
    end),[100,300,95,0,1,1,1],95,7941,50,132311,0x01f6ca40,Dict(1=>1,-22730=>-22730,-29512=>-29512,0=>32203,-7100=>-7100,22779=>22779,-22321=>22779,-24878=>-24878,458=>22779,-738=>32203,13024=>13024,32203=>1,-8455=>-8455,32063=>32063,21968=>32203,6512=>6512,-21968=>-21968,-11365=>32203,-14080=>-14080,23188=>-22730,-6815=>-6815,-12751=>-12751,11823=>-11365),[1752,817],135)

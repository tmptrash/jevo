[RpcApi.SimpleOrganism(0x000000000004e7c3,:(function (o::Creature.Organism,)
        ...
        function func_63(var_62::Int64=-5487471262987408691)
            ...
            Creature.stepUp(o)
            Creature.eatRight(o,Int(var_223))
            Creature.stepUp(o)
            Creature.stepUp(o)
            Creature.stepUp(o)
            return var_62
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,9313342,0x0000012d,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[23,279],151),RpcApi.SimpleOrganism(0x000000000004e7e4,:(function (o::Creature.Organism,)
        function func_234(var_233::Bool=true)
            Creature.stepLeft(o)
            return var_233
        end
        local var_197::Int8 = 93
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,9165994,0x0000013b,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>20703,-29091=>31438,1=>1),[12,264],150),RpcApi.SimpleOrganism(0x000000000004e6b3,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,8817244,0x00000131,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>20703,-29091=>31438,1=>1),[23,277],154),RpcApi.SimpleOrganism(0x000000000004e576,:(function (o::Creature.Organism,)
        function func_234(var_233::Bool=true)
            return var_233
        end
        local var_197::Int8 = 93
        ...
        function func_45(var_43::ASCIIString="D42FzkNp",var_44::ASCIIString="QVktoUuw")
            ...
            var_43 = var_44[1:if length(var_44) > length(var_44) > 0
                            ...
                            div(length(var_44),length(var_44))
                        end]
            return var_43
        end
        function func_25(var_24::Int64=5926471544133193903)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,8106884,0x00000138,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>20703,-29091=>31438,1=>1),[23,276],149),RpcApi.SimpleOrganism(0x000000000004e63c,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
        ...
        function func_9(var_8::Int8=-18)
            ...
            Creature.eatDown(o,Int(var_14))
            Creature.stepLeft(o)
            var_28 = Int(Creature.getEnergy(o,Int(var_13),Int(var_208)))
            Creature.eatDown(o,Int(var_14))
            Creature.eatUp(o,Int(var_14))
            Creature.stepDown(o)
            if var_8 !== var_14
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,8060472,0x00000128,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[9,278],150)]
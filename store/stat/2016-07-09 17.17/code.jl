julia> [RpcApi.SimpleOrganism(0x000000000004dd8f,:(function (o::Creature.Organism,)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,16583859,0x0000012c,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[15,292],151),RpcApi.SimpleOrganism(0x000000000004dd88,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            return var_195
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,16429730,0x0000012c,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[15,291],149),RpcApi.SimpleOrganism(0x000000000004dd7e,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,15754540,0x00000126,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[11,262],153),RpcApi.SimpleOrganism(0x000000000004df68,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            local var_230::Int16 = -30347
            Creature.stepLeft(o)
            return var_195
        end
        local var_161::Int8 = 81
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,15751883,0x0000012f,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[165,276],149),RpcApi.SimpleOrganism(0x000000000004dda7,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.eatUp(o,Int(var_195))
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,14351922,0x0000012c,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[11,261],152)]
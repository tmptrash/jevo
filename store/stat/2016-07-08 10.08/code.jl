[RpcApi.SimpleOrganism(0x0000000000049cda,:(function (o::Creature.Organism,)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,5083558,0x00000118,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[18,275],145),RpcApi.SimpleOrganism(0x0000000000049a2f,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            return var_195
        end
        ...
        local var_82::Int16 = -28253
        function func_63(var_62::Int64=-5487471262987408691)
            local var_228::Int64 = -865121800567061727
            local var_223::Int8 = 17
            Creature.stepUp(o)
            Creature.stepUp(o)
            if var_223 >= var_223
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,3011491,0x00000115,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[27,281],143),RpcApi.SimpleOrganism(0x0000000000049ce1,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
        ...
        Creature.eatUp(o,Int(var_197))
        var_55 = var_34 / var_34
        var_197 = var_12 / var_12
        var_131 = var_131 / var_131
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,2904687,0x00000117,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[8,250],144),RpcApi.SimpleOrganism(0x0000000000049e6c,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,2779870,0x00000116,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[18,288],144),RpcApi.SimpleOrganism(0x0000000000049db9,:(function (o::Creature.Organism,)
        local var_228::Bool = false
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            return var_195
        end
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,2639560,0x00000119,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[3,294],144)]
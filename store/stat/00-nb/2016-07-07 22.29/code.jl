[RpcApi.SimpleOrganism(0x000000000004794d,:(function (o::Creature.Organism,)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,3988756,0x00000110,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[1,264],140),RpcApi.SimpleOrganism(0x0000000000047941,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            return var_195
        end
        ...
        function func_63(var_62::Int64=-5487471262987408691)
            ...
            Creature.stepUp(o)
            if var_223 >= var_223
                local var_227::ASCIIString = "vXGWZkV6"
                Creature.stepUp(o)
            end
            Creature.stepUp(o)
            Creature.stepUp(o)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,3435034,0x00000115,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[117,254],141),RpcApi.SimpleOrganism(0x0000000000047784,:(function (o::Creature.Organism,)
        function func_228(var_227::Int16=24476)
            return var_227
        end
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,3297305,0x00000115,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[3,247],144),RpcApi.SimpleOrganism(0x0000000000047929,:(function (o::Creature.Organism,)
        function func_228(var_227::Int16=24476)
            return var_227
        end
        local var_197::Int8 = 93
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,3101367,0x00000115,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[33,289],144),RpcApi.SimpleOrganism(0x0000000000047480,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.stepRight(o)
            return var_195
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,2994939,0x00000116,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[6,262],141)]
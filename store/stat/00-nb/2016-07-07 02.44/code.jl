[RpcApi.SimpleOrganism(0x0000000000042ce9,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.eatDown(o,Int(var_195))
            Creature.eatDown(o,Int(var_195))
        ...
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        return true
    end),[100,300,95,0,1,1,1],7,9210,51,6614198,0x0000010b,Dict(20703=>-28253,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>20703,-29091=>31438,1=>1),[400,1],142),RpcApi.SimpleOrganism(0x000000000004358a,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            return var_195
        end
        ...
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        return true
    end),[100,300,95,0,1,1,1],7,9210,6,3733987,0x000000f6,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[10,275],139),RpcApi.SimpleOrganism(0x00000000000436f3,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            return var_195
        end
        ...
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        return true
    end),[100,300,95,0,1,1,1],7,9210,6,3445732,0x000000f4,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[10,276],141),RpcApi.SimpleOrganism(0x0000000000043647,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            return var_195
        end
        ...
        function func_63(var_62::Int64=-5487471262987408691)
            ...
            Creature.stepUp(o)
            Creature.eatUp(o,Int(var_223))
            return var_62
        end
        local var_55::Int64 = 8062249648076403993
        function func_45(var_43::ASCIIString="D42FzkNp",var_44::ASCIIString="QVktoUuw")
            local var_225::Int8 = -88
            local var_226::ASCIIString = "fCB66Lvs"
            Creature.stepDown(o)
            return var_43
        end
        function func_25(var_24::Int64=5926471544133193903)
        ...
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        return true
    end),[100,300,95,0,1,1,1],7,9210,6,3279585,0x000000f4,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[186,284],142),RpcApi.SimpleOrganism(0x000000000004392a,:(function (o::Creature.Organism,)
        ...
        function func_9(var_8::Int8=-18)
            ...
            var_13 = if haskey(o.mem,var_208)
                    o.mem[var_208]
                else
                    var_13
                end
        ...
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        return true
    end),[100,300,95,0,1,1,1],7,9210,7,3266302,0x000000fd,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[1,204],139)]
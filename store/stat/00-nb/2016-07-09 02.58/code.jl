[RpcApi.SimpleOrganism(0x000000000004c2e3,:(function (o::Creature.Organism,)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,4947236,0x00000123,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[5,187],152),RpcApi.SimpleOrganism(0x000000000004c160,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.stepDown(o)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,8328,6,3770165,0x00000125,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[9,283],150),RpcApi.SimpleOrganism(0x000000000004c24d,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.eatLeft(o,Int(var_195))
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,3540478,0x00000123,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[5,185],151),RpcApi.SimpleOrganism(0x000000000004c269,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.eatLeft(o,Int(var_195))
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,3323474,0x00000122,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[9,288],151),RpcApi.SimpleOrganism(0x000000000004c1b1,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.stepDown(o)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,8328,6,3307939,0x00000125,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[23,275],150)]
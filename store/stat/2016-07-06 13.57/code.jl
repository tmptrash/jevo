RpcApi.SimpleOrganism(0x000000000004223c,:(function (o::Creature.Organism,)
        ...
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        return true
    end),[100,300,95,0,1,1,1],7,9210,51,2682491,0x00000100,Dict(20703=>-28253,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>20703,-29091=>31438,1=>1),[399,3],138),RpcApi.SimpleOrganism(0x00000000000423b9,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
        ...
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        return true
    end),[100,300,95,0,1,1,1],7,9210,6,2465762,0x000000ea,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[118,269],141),RpcApi.SimpleOrganism(0x0000000000042423,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.eatDown(o,Int(var_195))
            Creature.eatUp(o,Int(var_195))
        ...
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        return true
    end),[100,300,95,0,1,1,1],7,9210,51,2093953,0x000000fe,Dict(20703=>-28253,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>20703,-29091=>31438,1=>1),[399,153],141),RpcApi.SimpleOrganism(0x00000000000416a2,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.stepLeft(o)
            return var_195
        ...
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        return true
    end),[100,300,95,0,1,1,1],7,9210,7,1949943,0x000000e0,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[279,285],137),RpcApi.SimpleOrganism(0x0000000000042728,:(function (o::Creature.Organism,)
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.stepDown(o)
            Creature.stepDown(o)
        ...
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        return true
    end),[100,300,95,0,1,1,1],7,9210,51,1907004,0x000000f7,Dict(20703=>-28253,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>20703,-29091=>31438,1=>1),[399,183],141)]
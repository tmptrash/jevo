[RpcApi.SimpleOrganism(0x000000000004e133,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.eatRight(o,Int(var_195))
            Creature.stepLeft(o)
            return var_195
        end
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,15063005,0x0000012e,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-25190=>-25190,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[11,244],152),RpcApi.SimpleOrganism(0x000000000004dfe8,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
        ...
        local var_55::Int64 = 8062249648076403993
        function func_45(var_43::ASCIIString="D42FzkNp",var_44::ASCIIString="QVktoUuw")
            var_43 = var_43[if length(var_44) > length(var_43)
                            1
                        else
                            length(var_44)
                        end:if length(var_44) > length(var_43) > 0
                            0
                        else
                            end
                        end]
            Creature.stepUp(o)
            Creature.stepLeft(o)
            var_43 = var_44[1:if length(var_44) > length(var_44)
                            0
                        else
                            length(var_44) - length(var_44)
                        end]
            return var_43
        end
        function func_25(var_24::Int64=5926471544133193903)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,12988593,0x0000012e,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[1,215],153),RpcApi.SimpleOrganism(0x000000000004e2d3,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            return var_195
        ...
        Creature.eatUp(o,Int(var_197))
        var_55 = var_34 / var_34
        var_55 = func_135(var_34)
        var_131 = var_131 / var_131
        var_55 = Int(Creature.getEnergy(o,Int(var_82),Int(var_131)))
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,10877699,0x0000012d,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[22,264],149),RpcApi.SimpleOrganism(0x000000000004e236,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            local var_230::Int8 = 31
            var_195 = var_195 * var_195
            return var_195
        end
        local var_161::Int8 = 81
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,10343611,0x00000130,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[11,243],152),RpcApi.SimpleOrganism(0x000000000004e34d,:(function (o::Creature.Organism,)
        local var_229::Int64 = 4656891210541358294
        local var_197::Int8 = 93
        function func_196(var_195::Int8=-12)
            Creature.stepLeft(o)
        ...
        Creature.stepUp(o)
        return true
    end),[100,300,95,0,1,1,1],0,9210,6,10111033,0x0000012e,Dict(20703=>20703,-2660=>-29091,0=>0,31438=>31438,-5320=>-5320,-26568=>31438,-26047=>13442,-572=>-572,17537=>-14079,-28253=>-28253,-29091=>31438,1=>1),[22,263],147)]
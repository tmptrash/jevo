...
module Organism
  ...
  function create()
    ...
    # @param {Creature} creature Instance of code related creature. This instance
    # will be used in organism's script during events fire.
    #
    code = :(function life(creature)
      begin
        #
        # ----------------------------------------------------------------------
    ...
    script = Script.Code(
      ...
      [[                                              # while(true) block
        "vars"  => Symbol[],
        "block" => code.args[2].args[4].args[2],
    ...
    #
    Creature(Config.mutator["organismStartEnergy"], [0, 0], script, Event.Observer())
  end
